...
public class Constants {
    ...
    public static final int NUM_ADS_BEFORE_SHOWING_BANNER = 3;
    ...
    public static int CHECK_TEMPERATURE_INTERVAL_MINUTES = 3;
    public static int CHECK_BATTERY_FULL_INTERVAL_MINUTES = 1;
